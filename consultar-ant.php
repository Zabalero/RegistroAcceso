...
<div>
	...
	?>	
		...
		<div class="opciones">
			...
			<input type="radio" name="autorizado" value="Si">S&iacute;
			<input type="radio" name="autorizado" value="No">No
			<input type="radio" name="autorizado" value="Todos">Todos	
		</div>
	
	
		<div class="opciones">
			<LABEL>Manual:</LABEL></br>
			<input type="radio" name="manual" value="Si">S&iacute;
			<input type="radio" name="manual" value="No">No
			<input type="radio" name="manual" value="Todos">Todos	
		</div>
...
$tsql = $tsql . " tbProvincias.Descripcion as Provincia FROM tbAccesos ";
...
*/
			...
			if (isset($fxRegistro2) && $fxRegistro2 != "")
							 $tsql = $tsql . " and Fx_Registro<='".$fxRegistro2."'";		
		...
		//print ("<h3>Resultado b&uacute;squeda</h3>");
			print ("<TABLE WIDTH='1400'>\n");
				print ("<TR>\n");
					...
					print ("<TH WIDTH='8%'>Nombre</TH>\n");
					print ("<TH WIDTH='12%'>Apellidos</TH>\n");
					print ("<TH WIDTH='5%'>Tel. T&eacute;cnico</TH>\n");
					print ("<TH WIDTH='7%'>Contrata</TH>\n");
					print ("<TH WIDTH='7%'>Subcontrata</TH>\n");
					print ("<TH WIDTH='18%'>C&aacute;mara</TH>\n");	
					print ("<TH WIDTH='7%'>Provincia</TH>\n");
					print ("<TH WIDTH='16%'>Poblaci&oacute;n</TH>\n");					
			...
			//while($row = sqlsrv_fetch_array($stmt)){		
				...
				if($i % 2){
					...
					print ("<TR class='even'>\n");
						...
						print ("<TD WIDTH='12%'>" . $row['Apellidos'] . "</TD>\n");
						print ("<TD WIDTH='5%'>" . $row['Telefono_Tecnico'] . "</TD>\n");					
						print ("<TD WIDTH='7%'>" . $row['Contrata'] . "</TD>\n");				
						print ("<TD WIDTH='7%'>" . $row['Subcontrata'] . "</TD>\n");
						print ("<TD WIDTH='18%'>" . $row['Camara'] . "</TD>\n");				
						print ("<TD WIDTH='7%'>" . $row['Provincia'] . "</TD>\n");
						print ("<TD WIDTH='16%'>" . $row['Poblacion'] . "</TD>\n");
